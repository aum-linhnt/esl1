...
### 5.1. Composer package đề xuất

```text
vendor/ai-tutor-core
vendor/ai-tutor-knowledge
vendor/ai-tutor-speaking
vendor/ai-tutor-writing
vendor/ai-tutor-recommendation
vendor/ai-tutor-analytics
vendor/ai-tutor-subject-english
vendor/ai-tutor-license-client
```

Có thể khởi đầu bằng modular monolith trong một repository. Ranh giới service/contract phải giữ để tách package sau này.
