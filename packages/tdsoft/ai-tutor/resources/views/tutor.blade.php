...
@section('content')
<div class="tai-license" data-tai-chat data-lesson="{{ $lesson->lessonId }}" data-api="{{ url('/ai-tutor/api/v1') }}">
    <h1>Gia sư AI</h1>
    <p>Bài học: {{ $lesson->lessonId }} · Chính sách đáp án do LMS quyết định.</p>
